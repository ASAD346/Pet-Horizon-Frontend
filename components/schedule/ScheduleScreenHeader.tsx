      ...
      <View style={styles.curveClipper}>
        ...
        >
          ...
          <View style={styles.row}>
            {/* Left: calendar/routine icon badge + text */}
            <View style={styles.leftContainer}>
              <View style={[
                ...
                <View style={styles.iconInnerContainer}>
                  <MaterialCommunityIcons name="calendar-clock-outline" size={18} color="#FFFFFF" />
                </View>
              </View>
            ...
            {/* Right: notification and journal action buttons */}
            <HeaderActionButtons
